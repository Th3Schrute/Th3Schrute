...
![SpriteKit](https://img.shields.io/badge/SpriteKit-FA7343?style=for-the-badge&logo=apple&logoColor=white)
...
#### **Law II: Delete before you optimize.**
...
#### **Law III: Simplify the system before you polish it.**
...
#### **Law IV: Accelerate only after the design is correct and lean.**
...
- 🤖 Building AI agents and automation pipelines with **Cursor AI**
- 🏠 Scaling a **PropTech platform** for landlords and property managers
- 📱 Shipping new **iOS apps** with Swift & SwiftUI
- 🕷️ Sharpening **Python automation** for real estate data intelligence
- 🌍 Open to collaborating on projects that make the world measurably better
...
![Brilliant Software](https://img.shields.io/badge/Brilliant_Software-💻-blue?style=flat-square)
